...
public class SobreVaari extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					SobreVaari frame = new SobreVaari();
...
//		lblNewLabel_1.setOpaque(false); // Asegura que el JLabel sea opaco para mostrar el color de fondo
		...
		JMenuItem Contacto = new JMenuItem("Guia");
		...
		SobreVaari.setText("VAARI - Aplicación de Gestión para Ancianos\r\n\r\nVAARI es una aplicación de gestión integral diseñada para facilitar el cuidado y la atención de personas mayores. Con un enfoque centrado en el bienestar y la comodidad de los ancianos, VAARI ofrece una plataforma intuitiva y personalizable que permite a los cuidadores y familiares organizar, monitorear y proporcionar atención de manera eficiente.\r\n\r\nAdemás, VAARI fomenta la participación activa de los ancianos en su propio cuidado, permitiéndoles registrar sus preferencias, intereses y actividades favoritas. Esto ayuda a promover la autonomía y la calidad de vida de las personas mayores, al tiempo que brinda tranquilidad a sus seres queridos.\r\n\r\n\r\nVersion: 1.0\r\n\r\n\r\nDesarrollado por: Equipo VAARI\r\n\r\n\r\nPara soporte, contáctenos en: support@vaariapp.com");
		SobreVaari.setBounds(74, 163, 536, 297);

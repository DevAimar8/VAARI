...
//		lblNewLabel_1.setOpaque(false); // Asegura que el JLabel sea opaco para mostrar el color de fondo
		...
		SobreVaari.setText("Soporte y Asistencia Técnica\r\n\r\n\r\n¡Bienvenido al apartado de soporte de VAARi! Estamos aquí para ayudarte con cualquier pregunta, problema técnico o comentario que tengas sobre nuestra aplicación. Por favor, selecciona una de las siguientes opciones para obtener la ayuda que necesitas:\r\n\r\nContacto por Correo Electrónico:\r\n\r\nSi tienes alguna pregunta o problema técnico, no dudes en contactarnos por correo electrónico. Nuestro equipo de soporte estará encantado de ayudarte.\r\n\r\nCorreo Electrónico: support@vaariapp.com");
		SobreVaari.setBounds(71, 161, 532, 309);
		...
		LABEL_FONDO.setBounds(0, -21, 633, 565);
